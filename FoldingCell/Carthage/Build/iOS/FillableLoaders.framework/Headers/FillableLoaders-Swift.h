...
SWIFT_MODULE_NAMESPACE_PUSH("FillableLoaders")
@class UIColor;
@class NSCoder;

SWIFT_CLASS("_TtC15FillableLoaders14FillableLoader")
@interface FillableLoader : UIView <CAAnimationDelegate>
...
@property (nonatomic, strong) UIColor * _Nullable loaderStrokeColor;
...
+ (nonnull instancetype)showLoaderWith:(CGPathRef _Nonnull)path on:(UIView * _Nullable)view SWIFT_WARN_UNUSED_RESULT;
/// Creates and SHOWS a progress based loader with the given path
/// :param: path Loader CGPath
/// :returns: The loader that’s already being showed
+ (nonnull instancetype)showProgressBasedLoaderWith:(CGPathRef _Nonnull)path on:(UIView * _Nullable)view SWIFT_WARN_UNUSED_RESULT;
/// Creates a loader with the given path
/// :param: path Loader CGPath
/// :returns: The created loader
+ (nonnull instancetype)createLoaderWith:(CGPathRef _Nonnull)path on:(UIView * _Nullable)view SWIFT_WARN_UNUSED_RESULT;
/// Creates a progress based loader with the given path
/// :param: path Loader CGPath
/// :returns: The created loader
+ (nonnull instancetype)createProgressBasedLoaderWith:(CGPathRef _Nonnull)path on:(UIView * _Nullable)view SWIFT_WARN_UNUSED_RESULT;
/// Shows the loader.
/// Atention: do not use this method after creating a loader with <code>showLoaderWithPath(path:)</code>
- (void)showLoader;
...
SWIFT_CLASS("_TtC15FillableLoaders11PlainLoader")
@interface PlainLoader : FillableLoader
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface PlainLoader (SWIFT_EXTENSION(FillableLoaders))
- (void)animationDidStop:(CAAnimation * _Nonnull)anim finished:(BOOL)flag;
@end


SWIFT_CLASS("_TtC15FillableLoaders13RoundedLoader")
@interface RoundedLoader : FillableLoader
/// Height of the rounded edge of the spike
@property (nonatomic) CGFloat spikeHeight;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


@interface RoundedLoader (SWIFT_EXTENSION(FillableLoaders))
- (void)animationDidStop:(CAAnimation * _Nonnull)anim finished:(BOOL)flag;
@end


SWIFT_CLASS("_TtC15FillableLoaders11SpikeLoader")
@interface SpikeLoader : FillableLoader
/// Height of the spike
@property (nonatomic) CGFloat spikeHeight;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface SpikeLoader (SWIFT_EXTENSION(FillableLoaders))
- (void)animationDidStop:(CAAnimation * _Nonnull)anim finished:(BOOL)flag;
@end


SWIFT_CLASS("_TtC15FillableLoaders11WavesLoader")
@interface WavesLoader : FillableLoader
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


@interface WavesLoader (SWIFT_EXTENSION(FillableLoaders))
- (void)animationDidStop:(CAAnimation * _Nonnull)anim finished:(BOOL)flag;
@end
